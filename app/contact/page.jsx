    ...
    <main style={{ minHeight: "100vh", backgroundColor: "#080412", padding: "60px 20px" }}>
      <div style={{ maxWidth: "700px", margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          <h1 style={{ fontSize: "clamp(28px, 7vw, 56px)", fontWeight: 800, color: "white", letterSpacing: "-1px", marginBottom: "14px" }}>
            Get in touch
          </h1>
        ...
        <div style={{ marginBottom: "32px" }}>
          {sent ? (
            <div style={{ textAlign: "center", padding: "48px 24px", backgroundColor: "rgba(139,92,246,0.05)", border: "1px solid rgba(139,92,246,0.2)", borderRadius: "20px" }}>
            ...
            <form onSubmit={handleSubmit} style={{ backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "20px", padding: "32px 24px", display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div>
                ...
                <textarea placeholder="Tell us what's on your mind..." value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} rows={5}
          ...
          {[
            ...
            return (
              <a key={item.label} href={item.href} target="_blank" rel="noopener noreferrer"
                style={{ display: "flex", alignItems: "center", gap: "12px", backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "14px", padding: "16px", textDecoration: "none", transition: "all 0.2s" }}
                ...
                <div style={{ width: "36px", height: "36px", borderRadius: "8px", backgroundColor: "rgba(139,92,246,0.1)", border: "1px solid rgba(139,92,246,0.2)", display: "flex", alignItems: "center", justifyContent: "center", color: "#a78bfa", fontSize: "16px", flexShrink: 0 }}>
                  <Icon />
                </div>
                <div style={{ minWidth: 0 }}>
                  <p style={{ color: "#6b7280", fontSize: "11px", marginBottom: "2px" }}>{item.label}</p>
                  <p style={{ color: "white", fontSize: "13px", fontWeight: 500, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{item.value}</p>
                </div>
              </a>
            );
          })}

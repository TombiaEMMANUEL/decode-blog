    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ color: "white", fontWeight: 700, fontSize: "22px", letterSpacing: "-0.5px" }}>
            Decode
          </span>
        </div>
        ...
        <p style={{ color: "#9ca3af", fontSize: "14px", marginBottom: "36px", lineHeight: 1.6 }}>
        ...
        {/* TERMS */}
        <p style={{ color: "#6b7280", fontSize: "11px", marginTop: "28px", lineHeight: 1.6 }}>
